...
def load_dump_to_array(filename, type_filter=None):
    frames = []
    ids_ref = None
    box_bounds = []
...
q_values_list = []
for frame in tqdm(X, desc="Computing q values for each frame"):
